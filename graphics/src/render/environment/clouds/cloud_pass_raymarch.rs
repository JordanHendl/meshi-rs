...
impl CloudRaymarchPass {
    ...
    pub fn update_settings(&mut self, settings: CloudSamplingSettings) {
        ...
        *params = CloudRaymarchParams {
            ...
            shadow_cascade_count: settings.shadow_cascade_count,
            ...
            weather_channels_a: settings.layer_a.weather_channels,
            debug_view: settings.debug_view,
            cloud_base_a: settings.layer_a.cloud_base,
            cloud_top_a: settings.layer_a.cloud_top,
            density_scale_a: settings.layer_a.density_scale,
            noise_scale_a: settings.layer_a.noise_scale,
            wind_a: [settings.layer_a.wind.x, settings.layer_a.wind.y],
            cloud_base_b: settings.layer_b.cloud_base,
            cloud_top_b: settings.layer_b.cloud_top,
            density_scale_b: settings.layer_b.density_scale,
            noise_scale_b: settings.layer_b.noise_scale,
            wind_b: [settings.layer_b.wind.x, settings.layer_b.wind.y],
            weather_channels_b: settings.layer_b.weather_channels,
