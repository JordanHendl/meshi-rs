...
impl CloudRenderer {
    ...
    pub fn update(
        ...
        let sampling = CloudSamplingSettings {
            ...
            shadow_cascade_count: self.settings.shadow.cascade_count,
            shadow_split_lambda: self.settings.shadow.split_lambda,
            shadow_cascade_splits: self.settings.shadow.cascade_splits,
            shadow_cascade_extents: self.settings.shadow.cascade_extents,
            shadow_cascade_resolutions: self.settings.shadow.cascade_resolutions,
