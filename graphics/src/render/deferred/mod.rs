...
use bento::builder::{PSO, PSOBuilder, AttachmentDesc};
use dashi::*;
...
impl DeferredRenderer {
    ...
    fn build_pipeline(&mut self, mat: &HostMaterial) -> PSO {
        ...
        let s = state
            .set_attachment_format("@entryPointOutput.normal", Format::BGRA8)
